  ...
  return (
    <div class="">
      ...
      <div class="grid gap-2 md:w-[618px] max-w-[618px] font-mono font-thin text-base text-wrap text-[#2d2d2d]">
        <br />
        <p>
          I am a software engineer in Fukuoka, Japan. Currently, I'm working at
          a FinTech company and developing a payment service with Ruby on Rails.
        </p>
        <p>
          I learned computer science at Kindai University and did research on
          blockchain, especially Bitcoin and stablecoin.
        </p>
